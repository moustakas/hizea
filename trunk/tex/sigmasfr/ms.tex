...
We use the method of \citet{mou11} to derive stellar masses and
UV-based SFRs from fits to the 0.1--5~$\mu$m SEDs.  We also estimate
IR-based SFRs from the 12~$\mu$m and 22~$\mu$m WISE photometry.

Comment on agreement between SFR indicators.
...
\begin{equation}
v_{esc} = \sqrt{2GM_{cl}/r_{cl}} = 2074~\textnormal{km~s}^{-1} \\%\left({v_c\over200}\right)^{5/2} 

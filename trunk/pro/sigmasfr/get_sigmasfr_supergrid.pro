function get_sigmasfr_supergrid, supergrid, nsuper=nsuper, superstring=superstring
; jm12feb16ucsd - read the supergrid parameter file    
    supergrid_paramfile = getenv('HIZEA_DIR')+'/pro/sigmasfr/sigmasfr_supergrid.par'

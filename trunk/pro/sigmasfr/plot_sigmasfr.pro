...
; jm12mar19ucsd - make the sigma-sfr vs mass plot
  ...
  ;!p.charthick=3
    ...
    djs_oplot, [11.0, 12.0], sigmasfr_edd*[1,1], line=0, color=im_color('grey90')
...
; Veilleux+06
    v06_sigmasfr = alog10(4.5D-44*10.0^veilleux.lir*im_lsun()/(!pi*veilleux.r50^2)/2.0)
    ...
    djs_oplot, v06_mass, v06_sigmasfr, psym=symcat(15), color='orange'
...
; Overzier+09
     ...
     djs_oplot, over.mgal, alog10(over.sfr / (2.*!pi*over.re^2)), $
...
; stellar mass from Scoville+97 is 2.5d9 (just for the nucleus)
    ...
    djs_oplot, [0., alog10(3.0d10)], [0., 2.98], $
